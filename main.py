...
def get_main_args():
    ...
    parser.add_argument("--optical_flow_off", action="store_true")
    parser.add_argument("--score_gallery_off", action="store_true")
...
def main():
    ...
    if args.dataset == "mot17":
        if args.test_dataset:
            ...
            # detector_path = "external/weights/yolox_x.pt"
        else:
    ...
    oc_sort_args = dict(
        ...
        optical_flow_off=args.optical_flow_off,
        score_gallery_off=args.score_gallery_off,
    )
